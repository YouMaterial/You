...
class YouRecipe(ConanFile):
    settings = "os", "compiler", "arch", "build_type"
    name = "You"
    license = "MIT"
    author = "QYou nrbnlulu@gmail.com"
    url = "https://github.com/YouMaterial/You"
    description = "Material implementation for QML"
    topics = ("QML", "UI", "Components", "Material")
    version = __version__
    ...
    def package_info(self):
        self.cpp_info.libs = ["You"]  # checks that can link against this lib name.
